...
## 2024-05-26 - Avoid Eager JSON Parsing in High-Frequency Streams
**Learning:** In high-frequency loops buffering streamed JSON chunks (e.g. SSE tool arguments), continually attempting to `json.loads` incomplete chunks and catching `JSONDecodeError` introduces severe computational overhead.
