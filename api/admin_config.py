...
FIELDS: tuple[ConfigFieldSpec, ...] = (
    ...
    ConfigFieldSpec(
        ...
        "runtime",
        "number",
        settings_attr="provider_max_connections",
        default="50",
    ),
    ConfigFieldSpec(
        "PROVIDER_MAX_KEEPALIVE_CONNECTIONS",
        "Provider Max Keepalive Connections",
        "runtime",
        "number",
        settings_attr="provider_max_keepalive_connections",
        default="20",
    ),
    ConfigFieldSpec(
        "HTTP_READ_TIMEOUT",
