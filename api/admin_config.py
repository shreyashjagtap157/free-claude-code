...
FIELDS: tuple[ConfigFieldSpec, ...] = (
    ...
    ConfigFieldSpec(
        ...
        secret=True,
        description="Gemini API key from aistudio.google.com/apikeys.",
    ),
    ConfigFieldSpec(
        "OPENCODE_API_KEY",
        "OpenCode API Key",
        ...
        secret=True,
        description="OpenCode Zen (opencode.ai/zen/v1) and OpenCode Go (opencode.ai/zen/go/v1); single key from opencode.ai/auth.",
    ),
    ConfigFieldSpec(
        "ZAI_API_KEY",
        "Z.ai API Key",
    ...
    ConfigFieldSpec(
        ...
        "runtime",
        "number",
        settings_attr="max_context_tokens",
        default="40000",
        description="Token budget for messages sent to OpenAI Chat providers (0=disabled).",
    ),
    ConfigFieldSpec(
        ...
        "runtime",
        "number",
        settings_attr="max_tool_result_tokens",
        default="4000",
        description="Per-tool-result token cap; oversized results are truncated (0=disabled).",
    ),
    ConfigFieldSpec(
        "ENABLE_CACHE",
        ...
        "runtime",
        "boolean",
        settings_attr="enable_cache",
        default="true",
        description="Cache identical requests to reduce provider API calls and latency.",
    ),
    ConfigFieldSpec(
        "CACHE_MAX_ENTRIES",
        "Cache Max Entries",
        "runtime",
        "number",
        settings_attr="cache_max_entries",
        default="256",
        description="Maximum number of cached response entries (LRU eviction).",
    ),
    ConfigFieldSpec(
        "CACHE_TTL_SECONDS",
        "Cache TTL (seconds)",
        "runtime",
        "number",
        settings_attr="cache_ttl_seconds",
        default="300",
        description="How long a cached response remains valid (0 = no expiry).",
    ),
    ConfigFieldSpec(
    ...
    ConfigFieldSpec(
        "FCC_SMOKE_MODEL_GOOGLE_AI_STUDIO",
        "Smoke Google AI Studio Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
